...
import { CreateTableBodyType, UpdateTableBodyType } from '@/schemaValidations/table.schema.js'
...
export const updateTable = (number: number, data: UpdateTableBodyType) => {
  if (data.changeToken) {
    ...
    // Transaction giải quyết bằng tính atom:
    // Tất cả bước thành công thì commit
    // Một bước lỗi thì rollback toàn bộ
